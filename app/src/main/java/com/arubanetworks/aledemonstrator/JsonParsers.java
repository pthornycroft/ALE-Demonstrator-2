...
public class JsonParsers {
	...
	// when anonymization is applied on ALE, it does not send sta_eth_mac element in JSON any more.  So added a boolean to indicate this is for a myMac or showTargetMac lookup.
		...
		try{
			...
			for(int i=0; i<locationArray.length(); i++){
				...
				if(myLocation == "true") {
					...
					MainActivity.site_errorAle = msgObject.getInt("error_level");
